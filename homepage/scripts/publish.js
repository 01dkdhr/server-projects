...
const publishPath = path.join(publicPath, package.name);
...
if (fs.existsSync(htmlPath)) {
    fs.copyFileSync(htmlPath, path.join(publishPath, 'index.html'));
}

copyDirection(distPath, path.join(publishPath, 'dist'));